...
class MainVideoFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.menu_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_LIST_VIEW, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Menu", wx.EmptyString, None )

		self.preview_tool = self.my_toolbar.AddTool( wx.ID_ANY, u"Preview", wx.ArtProvider.GetBitmap( wx.ART_MISSING_IMAGE, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None )

		self.proc_tool = self.my_toolbar.AddTool( wx.ID_ANY, u"Process", wx.ArtProvider.GetBitmap( wx.ART_MISSING_IMAGE, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_CHECK, wx.EmptyString, wx.EmptyString, None )

		self.view_step_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_MISSING_IMAGE, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Frame change step", wx.EmptyString, None )

		self.prev_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_GO_BACK, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Назад", wx.EmptyString, None )

		self.next_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_GO_FORWARD, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Next", wx.EmptyString, None )

		self.jump_frame_tool = self.my_toolbar.AddTool( ID_JUMP_FRAME_TOOL, u"frame | total", wx.ArtProvider.GetBitmap( wx.ART_TICK_MARK, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Jump to frame...", wx.EmptyString, None )

		self.jump_time_tool = self.my_toolbar.AddTool( ID_JUMP_TIME_TOOL, u"mm:ss.ms |mm:ss.ms", wx.ArtProvider.GetBitmap( wx.ART_TICK_MARK, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Jump to time...", wx.EmptyString, None )

		self.zoom_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_FIND, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_CHECK, u"Zoom / move image", wx.EmptyString, None )

		self.scrshot_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_MISSING_IMAGE, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_NORMAL, u"Screenshot", wx.EmptyString, None )

		self.points_tool = self.my_toolbar.AddTool( wx.ID_ANY, wx.EmptyString, wx.ArtProvider.GetBitmap( wx.ART_MISSING_IMAGE, wx.ART_TOOLBAR ), wx.NullBitmap, wx.ITEM_CHECK, u"Measure points coordinates", wx.EmptyString, None )
...
#		self.props_images_splitter.SetSashSize( 5 )
		...
		self.m_staticText241.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.source_button.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.m_staticText24.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.camera_list_button.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.pick_horizont_button.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.select_area_button.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.active_area_rename_button = wx.BitmapButton( self.m_panel111, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.active_area_rename_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_MISSING_IMAGE, wx.ART_MENU ) )
		...
		self.m_staticText31.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.express_spec_button.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.m_staticText34.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.json_text.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.apply_json_button = wx.BitmapButton( self.m_panel6, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.apply_json_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_TICK_MARK, wx.ART_MENU ) )
		self.apply_json_button.SetToolTip( u"Apply" )

		fgSizer10.Add( self.apply_json_button, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )

		self.reset_json_button = wx.BitmapButton( self.m_panel6, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.reset_json_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_UNDO, wx.ART_MENU ) )
		self.reset_json_button.SetToolTip( u"Undo" )

		fgSizer10.Add( self.reset_json_button, 0, wx.ALL|wx.ALIGN_RIGHT, 5 )

		self.json_defaults_button = wx.BitmapButton( self.m_panel6, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.json_defaults_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_GO_HOME, wx.ART_MENU ) )
		self.json_defaults_button.SetToolTip( u"Reset defaults" )
	...
	#	self.ab_splitter.SetSashSize( 5 )
		...
		self.a_footer_static_text.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.b_footer_static_text.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
		...
		self.corner_menu.Append( self.save_menu )
		...
		self.corner_menu.Append( self.save_as_menu )
		...
		self.corner_menu.Append( self.about_menu )
...
class ZoomDlg ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.es.SetToolTip( u"Do for left panel" )
		...
		self.m_button15.SetToolTip( u"Do for the right panel" )

		fgSizer13.Add( self.m_button15, 0, wx.ALL, 5 )

		self.a_to_corner_button = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.a_to_corner_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_GO_UP, wx.ART_BUTTON ) )
		self.a_to_corner_button.SetToolTip( u"Do for left panel" )
		...
		self.b_to_corner_button = wx.BitmapButton( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.b_to_corner_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_GO_UP, wx.ART_BUTTON ) )
		self.b_to_corner_button.SetToolTip( u"Do for the right panel" )
...
class SelDlg ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.del_button = wx.Button( self, wx.ID_ANY, u"Delete", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
		bSizer8.Add( self.del_button, 0, wx.EXPAND|wx.RIGHT|wx.LEFT, 5 )

		self.cancel_button = wx.Button( self, wx.ID_ANY, u"Cancel", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
...
class SourceDlg ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.auto_cmd_button.SetToolTip( u"Fill in default values" )
		...
		self.loader_cmd_help = wx.adv.HyperlinkCtrl( self.m_panel8, wx.ID_ANY, u"Help", wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.adv.HL_DEFAULT_STYLE )
		...
		self.loader_cmd_help.Bind( wx.adv.EVT_HYPERLINK, self.loader_cmd_help_func )
...
class PointsDlg ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Points", pos = wx.DefaultPosition, size = wx.Size( 250,500 ), style = wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER|wx.STAY_ON_TOP )
		...
		self.a2b_button = wx.Button( self, wx.ID_ANY, u"A -> B", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
		gSizer8.Add( self.a2b_button, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.b2a_button = wx.Button( self, wx.ID_ANY, u"A <- B", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
		gSizer8.Add( self.b2a_button, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.sel_a_button = wx.Button( self, wx.ID_ANY, u"Select on A", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
		gSizer8.Add( self.sel_a_button, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.sel_b_button = wx.Button( self, wx.ID_ANY, u"Select on В", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
		gSizer8.Add( self.sel_b_button, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_button23 = wx.Button( self, wx.ID_ANY, u"Compute...", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )
		gSizer8.Add( self.m_button23, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.close_button = wx.Button( self, wx.ID_ANY, u"Close", wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE )

...
class GrapherMainFB ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.clone_button = wx.BitmapButton( self.m_panel5, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.clone_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_COPY, wx.ART_TOOLBAR ) )
		self.clone_button.SetToolTip( u"Clone this window" )

		fgSizer5.Add( self.clone_button, 0, wx.ALL|wx.EXPAND, 5 )

		self.open_button = wx.BitmapButton( self.m_panel5, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.open_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_FILE_OPEN, wx.ART_TOOLBAR ) )
		self.open_button.SetToolTip( u"Open..." )

		fgSizer5.Add( self.open_button, 0, wx.ALL|wx.EXPAND, 5 )

		self.save_button = wx.BitmapButton( self.m_panel5, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.save_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_FILE_SAVE, wx.ART_TOOLBAR ) )
		self.save_button.SetToolTip( u"Save..." )

		fgSizer5.Add( self.save_button, 0, wx.ALL|wx.EXPAND, 5 )

		self.gnuplot_session_button = wx.BitmapButton( self.m_panel5, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.gnuplot_session_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_FIND, wx.ART_TOOLBAR ) )
		self.gnuplot_session_button.SetToolTip( u"Interactive mode" )

		fgSizer5.Add( self.gnuplot_session_button, 0, wx.ALL|wx.EXPAND, 5 )

		self.extra_menu_button = wx.BitmapButton( self.m_panel5, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.DefaultSize, wx.BU_AUTODRAW|0 )

		self.extra_menu_button.SetBitmap( wx.ArtProvider.GetBitmap( wx.ART_LIST_VIEW, wx.ART_TOOLBAR ) )
		self.extra_menu_button.SetToolTip( u"Extra menu" )
		...
		self.freqs_for_polar_text.SetToolTip( u"Список частот через пробел" )
		...
		self.extra_menu.Append( self.screenshot_menu )
